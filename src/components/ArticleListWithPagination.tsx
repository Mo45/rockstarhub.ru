// /src/components/ArticleListWithPagination.tsx
...
import { TbFolderFilled, TbCalendarWeek, TbChevronLeft, TbChevronRight } from 'react-icons/tb';
...
export default function ArticleListWithPagination({ 
  page = 1, 
  pageSize = 12, 
  ...
  return (
    <div>
      ...
      {showPagination && pagination.pageCount > 1 && (
