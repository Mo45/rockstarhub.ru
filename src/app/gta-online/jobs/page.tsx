  ...
  return (
    <div className="w-full mb-8">
      <div className="relative">
        ...
        />
        {searchQuery && (
          <div className="absolute z-20 w-full mt-1 bg-zinc-900 border border-zinc-800 rounded-lg shadow-lg max-h-96 overflow-y-auto">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="card rounded-lg p-6 md:p-8 mb-2 mt-8">
          <div className="prose max-w-none text-sm">
            ...
            <p>
              Рекомендуем обращать внимание на платиновые награды под каждым из дел, зачастую за получение всех доступных наград серии можно получить приятный бонус в виде GTA$! 
            </p>
          </div>
        </div>
